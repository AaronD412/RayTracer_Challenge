...
namespace RayTracerConsole
{
    ...
    /// </summary>
    public class TermPaperChapter07_08
    {
        /// <summary>
        /// Run this instance.
        /// </summary>
        public void Run()
        {
            System.Console.WriteLine("Example (term paper chapter 7.8)");
            ...
            canvas.ToPpm("term-paper-chapter07-08.ppm");
            System.Console.WriteLine("    term-paper-chapter07-08.ppm successfully written.");
        }
