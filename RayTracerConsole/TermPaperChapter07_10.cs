...
namespace RayTracerConsole
{
    ...
    /// </summary>
    public class TermPaperChapter07_10
    {
        /// <summary>
        /// Run this instance.
        /// </summary>
        public void Run()
        {
            System.Console.WriteLine("Example (term paper chapter 7.10)");
            ...
            canvas.ToPpm("term-paper-chapter07-10.ppm");
            System.Console.WriteLine("    term-paper-chapter07-10.ppm successfully written.");
        }
