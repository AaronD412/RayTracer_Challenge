...
namespace RayTracerTests
{
    ...
    public class ShadowsTests
    {
        ...
        public void LightingWithTheSurfaceInShadows()
        {
            ...
            // When
            Color result = material.GetLighting(new Sphere(), light, position, eyeVector, normalVector, 0);
        ...
        public void ThereIsNoShadowWhenNothingIsCollinearWithPointAndLight()
        {
            ...
            // Then
            Assert.IsFalse(defaultWorld.IsShadowed(point, defaultWorld.LightSources[0].Position));
        }
        ...
        public void TheShadowWhenAnObjectIsBetweenThePointAndTheLight()
        {
            ...
            // Then
            Assert.IsTrue(defaultWorld.IsShadowed(point, defaultWorld.LightSources[0].Position));
        }
        ...
        public void ShadeHitIsGivenAnIntersectionInShadow()
        {
            ...
            world.Shapes.Add(sphereOne);

            Sphere sphereTwo = new Sphere();
            sphereTwo.Transform = sphereTwo.Transform.Translate(0, 0, 10);

            world.Shapes.Add(sphereTwo);

            Ray ray = new Ray(new Point(0, 0, 5), new Vector(0, 0, 1));
            Intersection intersection = new Intersection(4, sphereTwo);

            // When
            PreparedIntersection intersections = intersection.Prepare(ray, new Intersections(intersection));
            Color shadeHit = world.ShadeHit(intersections);
        ...
        public void TheHitShouldOffsetThePoint()
        {
            ...
            // When
            PreparedIntersection preparedIntersection = intersection.Prepare(ray, new Intersections(intersection));
